package com.lost.zou.pedometer.presentation.view.component.leafLoading;
...
public class LeafLoadingView extends View {
    ...
    private void init() {
        ...
        mLeftMargin = DrawUtil.dip2px(LEFT_MARGIN);
        mRightMargin = DrawUtil.dip2px(RIGHT_MARGIN);
    ...
    private void initBitmap() {
        if (mResources.getDrawable(R.drawable.leaf) != null) {
        ...
        if (mResources.getDrawable(R.drawable.leaf_kuang) != null) {
