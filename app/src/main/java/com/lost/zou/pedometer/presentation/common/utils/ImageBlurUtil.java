...
public class ImageBlurUtil {
    ...
    public static Bitmap blur(Bitmap bkg, float blurWidthScale, float blurHeightScale, float leftScale, float topScale) {
        ...
        Bitmap overlay = Bitmap.createBitmap((int) (blurWidth / scaleFactor),
                (int) (blurHeight / scaleFactor), Bitmap.Config.ARGB_8888);
        ...
        return ImageUtil.zoomBitmap(overlay, blurWidth, blurHeight);
    }
